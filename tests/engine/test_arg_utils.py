...
@pytest.mark.parametrize(
    ("device_memory", "device_name", "is_xpu", "is_data_center_gpu", "expected"),
    [
        (16 * GiB_bytes, "RTX 4090", False, False, COMPACT_ACCELERATOR_DEFAULTS),
        (48 * GiB_bytes, "NVIDIA L40S", False, False, BALANCED_ACCELERATOR_DEFAULTS),
        (80 * GiB_bytes, "NVIDIA A100-SXM4-80GB", False, False, COMPACT_ACCELERATOR_DEFAULTS),
        (80 * GiB_bytes, "NVIDIA H100 SXM", False, False, LARGE_ACCELERATOR_DEFAULTS),
        (32 * GiB_bytes, "Intel Data Center GPU Max 1100", True, True, BALANCED_ACCELERATOR_DEFAULTS),
    ],
)
