...
"""
Usage:
TEST_PATH=$PWD/test/fuzz/low_rank_decompose/from_fixed/excludes/
...
def fuzz_test(input_bytes):
    excludes = input_bytes.decode('utf-8', 'ignore').strip()
    logging.info("excludes: %s", excludes)
    ...
    try:
        decomposer.from_fixed(16, excludes=excludes)
