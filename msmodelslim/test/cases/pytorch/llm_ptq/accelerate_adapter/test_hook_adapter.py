...
# 检查 accelerate 版本，如果不是 0.28.0 则跳过所有测试
try:
...
if accelerate_version != '0.28.0':
    pytestmark = pytest.mark.skip(reason=f"accelerate version is {accelerate_version}, required version is 0.28.0")
