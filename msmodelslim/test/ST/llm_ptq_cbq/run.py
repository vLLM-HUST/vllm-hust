...
msmodelslim_logger.info('cbq antioutlier is finished!')

quant_config = QuantConfig(a_bit=8, w_bit=8, dev_type='npu', act_method=1, pr=1.0, mm_tensor=False)
...
calibrator.save(f"{os.environ['PROJECT_PATH']}/output/llm_ptq_cbq", save_type=["safe_tensor"])
