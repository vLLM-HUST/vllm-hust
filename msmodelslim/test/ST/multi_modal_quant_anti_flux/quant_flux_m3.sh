...
# 清理output路径
rm -rf $PROJECT_PATH/output/multi_modal_quant_anti_flux/m3/*
...
python inference_flux.py \
    --path ${MODEL_PATH} \
    --save_path "$PROJECT_PATH/output/multi_modal_quant_anti_flux/m3/results/quant/img" \
    --device_id 0 \
    --device "npu" \
    ...
    --max_num_prompt 0 \
    --do_quant \
    --quant_weight_save_folder "$PROJECT_PATH/output/multi_modal_quant_anti_flux/m3/results/quant/safetensors" \
