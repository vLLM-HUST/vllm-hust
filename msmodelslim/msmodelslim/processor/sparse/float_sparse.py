...
from msmodelslim.processor.sparse.admm import AdmmPruner
from msmodelslim.ir.w16a16s import W16A16sLinear
...
@logger_setter(prefix="msmodelslim.processor.float_sparse")
