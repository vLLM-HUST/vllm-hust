...
class ChatCompletionRequest(OpenAIBaseModel):
    ...
    def _materialize_tool_calls_before(cls, data: Any) -> Any:
        ...
        This must happen before Pydantic field validation so one-shot
        iterators are not consumed during union type matching.
        """
    ...
    def _materialize_tool_calls_after(self) -> "ChatCompletionRequest":
        """Convert Pydantic iterator wrappers back to plain lists."""
