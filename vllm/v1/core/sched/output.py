...
class NewRequestData:
    ...
    def from_request(
        ...
        assert request.state_lease_generation > 0
        return cls(
            ...
            state_lease_generation=request.state_lease_generation,
    ...
    def __repr__(self) -> str:
        ...
        return (
            ...
            f"state_lease_generation={self.state_lease_generation},"
